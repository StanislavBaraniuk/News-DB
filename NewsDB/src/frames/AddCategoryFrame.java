...
public class AddCategoryFrame extends javax.swing.JFrame {
     ...
     */
    public AddCategoryFrame(Controller controller) {
        initComponents();
        AddCategoryFrame.controller = controller;
    ...
    private void initComponents() {
        ...
        homeComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-" }));
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(homeComboBox, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addContainerGap())
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (TextField1.getText().length() > 0) {
            String home = homeComboBox.getSelectedIndex() > 0 ? homeComboBox.getItemAt(homeComboBox.getSelectedIndex()).split(" ")[1] : null;
            controller.add_category(TextField1.getText(), home);
            controller.consecrate_id(controller.load_categorys());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddCategoryFrame(controller).setVisible(true);
            }
        });
    }
