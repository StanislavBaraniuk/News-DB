 ...
 * @author stanislaw
 */
public class OprosFrame extends javax.swing.JFrame {
    private static Controller controller;
    /**
     * Creates new form OprosFrame
     */
    public OprosFrame(Controller controller) {
        initComponents();
...
//        jLabel2.setIcon(controller.frameController.createIcon("/res/img/ok_standart.png"));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Текст варіанту");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OprosFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OprosFrame(controller).setVisible(true);
            }
        });
    }
